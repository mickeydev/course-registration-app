...
function CourseForm() {
    ...
    async function OnSubmitHandler(e: FormEvent<HTMLFormElement>) {
        e.preventDefault();
        try {
            if (courseFormDetails.title.trim().length === 0 || courseFormDetails.prerequisite.trim().length === 0) { return }
    ...
    return (
        <Box m={2}>
            ...
            <form onSubmit={OnSubmitHandler}>
                ...
                <TextField name="prerequisite" label="Prerequisite" type="text" variant="standard" sx={{ mt: 2 }} fullWidth InputLabelProps={{
                    shrink: true,
                }} onChange={OnChangeHandler} />
