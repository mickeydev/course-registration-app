import React, { createContext, useState, useEffect, ReactElement, JSXElementConstructor } from "react";
...
function RegContextProvider({ children }: Props) {
    ...
    return (
        <RegContext.Provider value={values}>
            {children}
        </RegContext.Provider>
    )
}
